# -*- coding: utf-8 -*-
"""self_att_cnn_selective_att.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1C9Bni_HNF1ySWfCoWWGPrC6--1v5gWRU
"""
...
# model defination
class self_att_cnn_selective_att(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.config = config
...
def train_model():
  ...
  con.att_dropout = 0.5
  con.start_epoch = 9
  con.pretrain_model = "/content/drive/My Drive/Colab Notebooks/BS/checkpoint/self_att_cnn_selective_att-8-0.10687473633283828"
  # pretrained_model = 
  con.set_train_model(self_att_cnn_selective_att)
  con.train()
