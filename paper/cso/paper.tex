...
卷积神经网络（PCNNs)\upcite{bib3, bib10}，长短时记忆网络（LongShort Term Memory Network）\upcite{bib4, bib9} 等都在关系抽取领域的句子特征提取上取得了成功。
...
\subsection{训练设置}
为了方便比较，与前人工作\upcite{bib3, bib4}相同，本本文设置词嵌入向量维度为50，每一个位置嵌入向量维度为5。
...
\begin{thebibliography}{11}
    ...
    \bibitem{bib9} Cai Rui, Zhang Xiaodong, Wang Houfeng, Bidirectional Recurrent Convolutional NeuralNetwork for Relation Classsification, Proceedings of the 54th Annual Meeting of the Association for Computational Linguistics, 2016.
    \bibitem{bib10} Zeng Daojian, Liu Kang, Lai Siwei，et al., Relation Classification via Convolutional Deep Neural Network, Proceedings of COLING 2014, the 25th International Conference on Computational Linguistics, 2014.
    \bibitem{bib11} Sun Tingting, Zhang Chunhong, Ji Yang, et al., "MSnet: Multi-Head Self-Attention Network for Distantly Supervised Relation Extraction", Access IEEE, vol. 7, pp. 54472 - 54482, 2019.
